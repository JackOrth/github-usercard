...
*/
const myURL = 'https://api.github.com/users/JackOrth'
const entryPoint = document.querySelector(".cards")
const getData = () =>{ 
    axios.get(myURL)
      .then(res =>{
      entryPoint.appendChild(template(res.data))
      })
      .catch(err =>{
      console.log(err)
      })
...
function template(object) {
  ...
  webAddress.href = object["html_url"]
  profile.appendChild(webAddress)
  webAddress.textContent = "Github"
